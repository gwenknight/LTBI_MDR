### Code to fit splines to WHO data for all countries
...
who0 <- as.data.frame(read.csv("~/Dropbox/MDR/new_who_edited_sub.csv"))[,-1] #Documents/MDR-LTBI-paper/data_final/new_who_edited_sub.csv")[,-1]) 
...
uu <- read.csv("~/Dropbox/MDR/138_final_list_included_countries.csv") #read.csv("data_final/138_final_list_included_countries.csv",stringsAsFactors = FALSE)[,-1]
