...
write.csv(med.ltbir, "~/Dropbox/MDR/output_gaussian/med_pop_ltbir.csv")
...
write.csv(table1_countries, paste0("~/Dropbox/MDR/paper_output_gaussian/table1_countries_",labl,".csv"))
write.csv(table1_countries_numb, paste0("~/Dropbox/MDR/paper_output_gaussian/table1_countries_number_",labl,".csv"))
write.csv(table1_global, paste0("~/Dropbox/MDR/paper_output_gaussian/table1_global_",labl,".csv"))
write.csv(table1_global_numb, paste0("~/Dropbox/MDR/paper_output_gaussian/table1_global_numb_",labl,".csv"))

table1_paper <- merge(table1_countries, table1_countries_numb, by = c("iso3","WHO region"))
write.csv(table1_paper, paste0("~/Dropbox/MDR/paper_output_gaussian/S2_results.csv"))
...
ggsave(paste0("~/Dropbox/MDR/output_gaussian/global_levels_ltbir_",pp,".pdf"),width=13, height=8)
...
pdf(paste0("~/Dropbox/MDR/output_gaussian/map_ltbis_kids_",nari,"_infor_prior.pdf"))
...
pdf(paste0("~/Dropbox/MDR/output_gaussian/map_ltbir_kids_",nari,"_infor_prior.pdf"))
...
pdf(paste0("~/Dropbox/MDR/output_gaussian/map_ltbir_",nari,"_infor_prior.pdf"))
...
pdf(paste0("~/Dropbox/MDR/output_gaussian/map_2035.pdf"))
...
pdf(paste0("~/Dropbox/MDR/output_gaussian/map_2050.pdf"))
mapParams <- mapCountryData(mapped_data, nameColumnToPlot = "propr", catMethod = seq(0,4,0.25),
                            colourPalette = cols,
                            addLegend = FALSE,missingCountryCol = gray(.8))
do.call( addMapLegend, c( mapParams
...
for(cci in 1:length(cni)){
  ...
  ggsave(paste0("~/Dropbox/MDR/output_gaussian/",cni[cci],"_mdr_trends_with_data_",pp,".pdf"),width=11, height=11)
  ...
  ggsave(paste0("~/Dropbox/MDR/output_gaussian/",cni[cci],"_mdr_ari_",pp,".pdf"),width=11, height=11)
  
}    

## All trends
# theme_set(theme_bw(base_size = 10))
# pdf("~/Dropbox/MDR/output_gaussian/trends_all.pdf")
# for(i in 1:9){
...
# All ARI trends
theme_set(theme_bw(base_size = 10))
pdf("~/Dropbox/MDR/output_gaussian/trends_ari_all.pdf")
for(i in 1:9){
...
ggsave(paste0("~/Dropbox/MDR/output_gaussian/SEA_mdr_trends_with_data_",pp,".pdf"),width=13, height=11)
...
ggsave(paste0("~/Dropbox/MDR/output_gaussian/SEA_mdr_trends_with_data_ribbon_",pp,".pdf"),width=13, height=11)
...
ggsave(paste0("~/Dropbox/MDR/output_gaussian/SEA_ari_trends_",pp,".pdf"),width=13, height=11)
...
ggsave(paste0("~/Dropbox/MDR/output_gaussian/LTBI_by_ds_region_",pp,".pdf"),width=14, height=11)
...
ggplot(mplot14s, aes(x=age, y = med.perc/100)) + geom_bar(fill = "blue",stat='identity', pos = "dodge") + 
  ...
  scale_y_continuous("DS-LTBI prevalence",labels = scales::percent_format(accuracy = 1)) +
  scale_x_discrete("Age")
ggsave(paste0("~/Dropbox/MDR/output_gaussian/LTBI_by_ds_region_",pp,"regions.pdf"),width=14, height=11)
...
ggplot(mplot14r, aes(x=age, y = med.perc/100)) + geom_bar(aes(fill = variable),stat='identity') + 
  ...
  scale_x_discrete("Age")
ggsave(paste0("~/Dropbox/MDR/output_gaussian/LTBI_mdr_region_",pp,".pdf"),width=14, height=11)
...
ggplot(mplot14r, aes(x=age, y = med.perc/100)) + geom_bar(aes(fill = variable),stat='identity') + 
  ...
  scale_y_continuous("MDR-LTBI prevalence",labels = scales::percent_format(accuracy = .1)) +
  scale_x_discrete("Age")
ggsave(paste0("~/Dropbox/MDR/output_gaussian/LTBI_mdr_region_",pp,"regions.pdf"),width=14, height=11)
...
ggsave(paste0("~/Dropbox/MDR/output_gaussian/ARI_region_ribbon_",pp,".pdf"),width=14, height=11)
...
ggplot(arimplot7, aes(x=year)) + geom_line(aes(y = mdr_ari)) + 
  ...
  facet_wrap(~g_reg, scales = "free") + 
  scale_y_continuous("ARI with MDR M.tb") + scale_x_continuous(lim = c(1960, 2020))
ggsave(paste0("~/Dropbox/MDR/output_gaussian/ARI_region_ribbon_50_",pp,".pdf"),width=14, height=11)
...
ggsave(paste0("~/Dropbox/MDR/output_gaussian/ARI_region_",pp,".pdf"),width=14, height=11)
