...
for(cci in 1:llu){
  ...
  for(i in 1:nari){
    ...
    cc <- cohort_ltbi_mixed(ari, pop)
    
    # Proportion mixed? 
    cc14 <- cc$c_2014
    
    m1<-rbind(m1, c(mean(100*cc14$pr_dsr / (cc14$pr_dr + cc14$pr_drs + cc14$pr_ds + cc14$pr_dsr)), # 0.009%
                    mean(100*cc14$pr_drs / (cc14$pr_dr + cc14$pr_drs + cc14$pr_ds + cc14$pr_dsr)), # 0.04%
                    mean(100*cc14$pr_ds / (cc14$pr_dr + cc14$pr_drs + cc14$pr_ds + cc14$pr_dsr)), # 99%
                    mean(100*cc14$pr_dr / (cc14$pr_dr + cc14$pr_drs + cc14$pr_ds + cc14$pr_dsr)), # 0.9%
                    
                    mean(100*cc14$rei_rssr / (cc14$rei_rs + cc14$rei_rssr + cc14$rei_sr + cc14$rei_srrs), na.rm = TRUE), # 1% 
                    mean(100*cc14$rei_srrs / (cc14$rei_rs + cc14$rei_rssr + cc14$rei_sr + cc14$rei_srrs), na.rm = TRUE), # 0.006%   
                    mean(100*cc14$rei_rs / (cc14$rei_rs + cc14$rei_rssr + cc14$rei_sr + cc14$rei_srrs), na.rm = TRUE), # 20%
                    mean(100*cc14$rei_sr / (cc14$rei_rs + cc14$rei_rssr + cc14$rei_sr + cc14$rei_srrs), na.rm = TRUE),
                    
                    mean(100*cc14$new_ds / (cc14$new_ds + cc14$new_dr + cc14$rei_rs + cc14$rei_rssr + cc14$rei_sr + cc14$rei_srrs), na.rm = TRUE), # 93% 
                    mean(100*cc14$new_dr / (cc14$new_ds + cc14$new_dr + cc14$rei_rs + cc14$rei_rssr + cc14$rei_sr + cc14$rei_srrs), na.rm = TRUE), # 6%   
                    mean(100*cc14$rei_rs / (cc14$new_ds + cc14$new_dr + cc14$rei_rs + cc14$rei_rssr + cc14$rei_sr + cc14$rei_srrs), na.rm = TRUE), # 0.1%
                    mean(100*cc14$rei_sr / (cc14$new_ds + cc14$new_dr + cc14$rei_rs + cc14$rei_rssr + cc14$rei_sr + cc14$rei_srrs), na.rm = TRUE))# 0.7%   
    )
...
colnames(m1) <- c("dsr","drs","ds","dr","rssr","srrs","rs","sr")
write.csv(m1, "~/Dropbox/MDR/output/mean_mixed_levels.csv")
numcolwise(mean)(m1) # 0.02, 0.07, 98, 1.7: proportion of totals in each. 0.9, 0.02, 18, 80: percentage of reinfections due to what
# => < 1% are mixed
...
a2r
save_plot(paste0("~/Dropbox/MDR/output/ltbi_all_countries_r",nari,"_",pp,".pdf"), a2r, base_aspect_ratio = 1.5 )
...
a2s
save_plot(paste0("~/Dropbox/MDR/output/ltbi_all_countries_s",nari,"_",pp,".pdf"), a2s, base_aspect_ratio = 1.5 )
...
a2r
save_plot(paste0("~/Dropbox/MDR/output/ltbi_all_countries_r_mean",nari,"_",pp,".pdf"), a2r, base_aspect_ratio = 0.8)
...
a2s
save_plot(paste0("~/Dropbox/MDR/output/ltbi_all_countries_s_mean",nari,"_",pp,".pdf"), a2s, base_aspect_ratio = 1.5 )
