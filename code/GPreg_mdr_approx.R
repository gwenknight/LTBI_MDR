...
####**** Load data ********************************************************************************************************************************************************************#####
load('datar/All_mdr_approx.Rdata')
Allm <- Allm_approx
...
for(jj in 1:length(uu)){
  ...
  if(lin > 0){save(erw,file=paste0('datar_approx/',cn,'.Rdata'))}
  if(lin == 0){save(erw,file=paste0('datar_const_approx/',cn,'.Rdata'))}
  ...
  if(lin > 0){save(runsdf,file=paste0('datar_approx/zz_',cn,'.Rdata')); print(paste0('datar_approx/zz_',cn,'.Rdata'))}
  if(lin == 0){save(runsdf,file=paste0('datar_const_approx/zz_',cn,'.Rdata')); print(paste0('datar_approx/zz_',cn,'.Rdata'))}
  
}

uu <- uu[-skp]
save(uu,file='datar_approx/uu.Rdata')
