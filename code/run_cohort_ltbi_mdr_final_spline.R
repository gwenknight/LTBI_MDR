...
## Which countries? 
cni <- read.csv("../MDR-LTBI-paper/data_final/138_final_list_included_countries.csv",stringsAsFactors = FALSE)[,-1] # all 138
cni <- read.csv("data/3_spline_included_countries.csv",stringsAsFactors = FALSE)[,-1] # 3 for sensitivity analysis
